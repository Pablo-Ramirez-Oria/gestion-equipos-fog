<x-layouts.app :title="__('Gestión de equipos en el FOG - Editar Ubicación')">
    <h1 class="text-2xl mb-4">Editar Ubicación</h1>
    ...
    <form method="POST" action="{{ route('ubicaciones.update', $ubicacion) }}" class="max-w-3xl space-y-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        @csrf
        @method('PUT')
