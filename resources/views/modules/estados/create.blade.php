<x-layouts.app :title="__('Gestión de equipos en el FOG - Nuevo Estado')">
    <h1 class="text-2xl mb-4">Crear Estado</h1>
    ...
    <form method="POST" action="{{ route('estados.store') }}" class="max-w-3xl space-y-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        @csrf
